...
fn conversions() {
    ...
    assert_eq!(u8_to_u64(&[128, 128, 128, 128, 128, 128, 128, 128], 0),
               0x8080808080808080);
    assert_eq!(u8_to_u64(&[255, 255, 255, 255, 255, 255, 255, 255], 0),
               0xFFFFFFFFFFFFFFFF);
    assert_eq!(u8_to_u64(&[255, 255, 255, 255, 255, 255, 255, 255, 0], 1),
               0x00FFFFFFFFFFFFFF);
    ...
    assert_eq!(u8_to_string(&[66, 111, 110, 106, 111, 117, 114], 7),
               "Bonjour".to_string());
    assert_eq!(u8_to_string(&[67, 111, 110, 110, 97, 114, 100, 0, 0, 0], 10),
               "Connard".to_string());
    assert_eq!(u8_to_string(&[67, 111, 117, 99, 111, 117, 0], 7),
               "Coucou".to_string());
}
